...
const AccessTitle: FC = () => {
  return (
    <div className='flex gap-x-6 p-2 mb-2 border text-center sticky top-0 bg-neutral-300 border-neutral-300'>
      ...
      <p className='flex items-center justify-center w-1/12'>Registrar</p>
    </div>
  );
};
